...
int main(){
	...
	A.addEnd(11); for (int i=0; i< A.length();i++) cout << A[i] << " ";  cout << endl;
	A.addFront(1); for (int i=0; i< A.length();i++) cout << A[i] << " ";  cout << endl;
	A.addFront(2); for (int i=0; i< A.length();i++) cout << A[i] << " ";  cout << endl;
	A.addFront(3); for (int i=0; i< A.length();i++) cout << A[i] << " ";  cout << endl;
